...
try:
    version = release = get_distribution('web-utils').version
except Exception:
    traceback.print_exc()
...
html_theme_options = {
    ...
    'github_repo': 'web-utils',
    'fixed_sidebar': 'false',
    'description': 'This is a library containi utilities to assist in activities related to my website.',
    'badge_branch': 'master',
    'github_banner': 'true',
    'github_button': 'true',
    'travis_button': 'true',
